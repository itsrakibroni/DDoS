 ...
 * ðŸ’£ Layer7
   ...
   * ðŸ”ª KILLER | Run many threads to kill a target
   * ðŸ§… TOR | Bypass onion website
...
`
  * ðŸŒŸ CFIP | Find Real IP Address Of Websites Powered By Cloudflare
  * ðŸ”ª DNS | Show DNS Records Of Sites
  * ðŸ“  TSSRV | TeamSpeak SRV Resolver
  * âš   PING | PING Servers
  * ðŸ“Œ CHECK | Check If Websites Status
  * ðŸ˜Ž DSTAT | That Shows Bytes Received, bytes Sent and their amount

* ðŸŽ© Other
  * âŒ STOP | STOP All Attacks
  * ðŸŒ  TOOLS | Console Tools
  * ðŸ‘‘ HELP | Show Usage Script
